...
namespace LaurentiuCristofor.Proteus.DataProcessors
{
    ...
    /// </summary>
    public class SplitColumnStringsProcessor : BaseOutputProcessor, IDataProcessor<StringAndIntOutputParameters, ParsedLine>
    {
        protected StringAndIntOutputParameters Parameters { get; set; }
        ...
        public void Initialize(StringAndIntOutputParameters processingParameters)
        {
            this.Parameters = processingParameters;

            ArgumentChecker.CheckNotNullAndNotEmpty(this.Parameters.StringValue);
            ArgumentChecker.CheckStrictlyPositive(this.Parameters.IntValue);
        ...
        public bool Execute(ulong lineNumber, ParsedLine lineData)
        {
            ...
            //
            if (this.Parameters.IntValue > lineData.Columns.Length)
            {
            ...
            {
                string columnValue = lineData.Columns[this.Parameters.IntValue - 1];
