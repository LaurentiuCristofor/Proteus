            ...
            public abstract class Arguments
            {
                ...
                public abstract class Descriptions
                {
                    ...
                    public static readonly string StringEditTypeText = $"{Constants.Commands.Arguments.Descriptions.EditType} can take the values:"
                        ...
                        + $"\n\t- '{Constants.Commands.Arguments.StringEditTypePadLeft}' = pad left; arguments: <padding_character> <padding_size>"
                        + $"\n\t- '{Constants.Commands.Arguments.StringEditTypePadRight}' = pad right; arguments: <padding_character> <padding_size>"
